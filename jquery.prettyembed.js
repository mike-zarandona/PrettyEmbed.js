...
(function ($, undefined) {
	$.fn.prettyEmbed = function (options) {
		...
		elem.html('<img src="http://img.youtube.com/vi/' + options.videoID + '/maxresdefault.jpg" alt="YouTube Video Thumbnail" />');
		...
		elem.on('click', function() {
			...
			$(this).html('<iframe width="' + wrapperWidth + '" height="' + wrapperHeight + '" src="http://www.youtube.com/embed/' + options.videoID + '?autoplay=1' + playerOptions + '"></iframe>')
